...
void init_system()
{
    ...
    status_control_init( &status_control_status, &command_ctrl_task, &buff_status );
...
void app_main( void )
{
    ...
    http_task_handle = xTaskCreateStaticPinnedToCore( http_task,                /* Function that implements the task. */
